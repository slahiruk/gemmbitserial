...
class RowInterleavedBitSerialMatrix {
public:
  // static member functions for working with RowInterleavedBitSerialMatrix
  ...
  /* Deallocate buffers for a RowInterleavedBitSerialMatrix */
  static void dealloc(RowInterleavedBitSerialMatrix ribsm) {
    delete [] ribsm.data;
  }
